...
struct RestcCppException : public std::runtime_error {
  ...
  RestcCppException(const std::string &cause) : runtime_error(cause) {}
};
...
struct HttpProxyAuthenticationRequiredException
  ...
  HttpProxyAuthenticationRequiredException(const Reply::HttpResponse &response)
      : RequestFailedWithErrorException(response) {}
};
...
struct ParseException : public RestcCppException {
  ParseException(const std::string &cause) : RestcCppException(cause) {}
};
...
struct ProtocolException : public RestcCppException {
  ProtocolException(const std::string &cause) : RestcCppException(cause) {}
};

struct AccessDeniedException : public RestcCppException {
  AccessDeniedException(const std::string &cause) : RestcCppException(cause) {}
};

struct ConstraintException : public RestcCppException {
  ConstraintException(const std::string &cause) : RestcCppException(cause) {}
};

struct NotSupportedException : public RestcCppException {
  NotSupportedException(const std::string &cause) : RestcCppException(cause) {}
};

struct CommunicationException : public RestcCppException {
  CommunicationException(const std::string &cause) : RestcCppException(cause) {}
};
...
struct DecompressException : public RestcCppException {
  DecompressException(const std::string &cause) : RestcCppException(cause) {}
};

struct NoDataException : public RestcCppException {
  NoDataException(const std::string &cause) : RestcCppException(cause) {}
};
...
struct IoException : public RestcCppException {
  IoException(const std::string &cause) : RestcCppException(cause) {}
};

struct ObjectExpiredException : public RestcCppException {
  ObjectExpiredException(const std::string &cause) : RestcCppException(cause) {}
};

struct RequestTimeOutException : public RestcCppException {
  RequestTimeOutException() : RestcCppException("Request Timed Out") {}
};
